...
import com.mgk.account.book.common.utils.LongToEmptyConverter;
import com.mgk.account.book.common.utils.StringToDateConverter;
...
public class DateConfig {
	...
	public void initEditableValidation() {
		...
		if (initializer.getConversionService() != null) {
			...
			genericConversionService.addConverter(new LongToEmptyConverter());
		}
	}
}